let todos = [
  ...
  export default function WorkingWithArrays(app) {
    // GET - Retrieve all todos or filter by completed
    ...
    // GET - Create new todo (old way - for backwards compatibility)
    ...
    // POST - Create new todo (proper way with JSON body)
    ...
    // GET - Remove todo (old way - for backwards compatibility)
    ...
    // DELETE - Remove todo (proper way with error handling)
    ...
    // GET - Update todo title (old way - for backwards compatibility)
    ...
    // GET - Update todo description (old way)
    ...
    // GET - Update todo completed (old way)
    ...
    // PUT - Update todo (proper way with JSON body and error handling)
